...
const MyArtList = () => {
    ...
    useEffect(() => {
        fetch(`https://ceramic-arena-server.vercel.app/craft/${user.email}`)
            .then(res => res.json())
            .then(data => {
                setItems(data);
            });
    ...
    return (
        <div className="">
            ...
            <div className="flex justify-center my-8">
                <label className="mr-2 font-bold">Filter by Customization:</label>
                <select
...
//     useEffect(() => {
//         let url = `https://ceramic-arena-server.vercel.app/craft/${user.email}`;
        
//         // Append query parameter if filterCustomization is set
//         if (filterCustomization) {
//             url += `?customization=${filterCustomization}`;
//         }
